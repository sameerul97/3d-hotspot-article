  ...
  if (!isMobile)
    return (
      <Suspense fallback={null}>
        <AnimCloud position={[-1, 1, -35]} position-y={1} position-z={-35} speed={0} opacity={0.5} segments={20} width={8} length={0.5} />
        <AnimCloud position={[1, 2, -18]} position-y={2} position-z={-18} speed={0} opacity={1} segments={20} width={15} />
